...
public class PoliDokterController {
    ...
    public ResponseEntity<?> getDaftarAntreanPoli() {
        // Mengambil semua janji yang belum selesai
    ...
    public ResponseEntity<?> selesaikanPemeriksaan(@RequestBody Map<String, String> data) {
        try {
            // Kita ubah janjiId dari String ke Long agar cocok dengan pencarian database
            ...
            if (janjiOpt.isPresent()) {
                ...
                // Menyimpan Diagnosis dan Resep ke dalam kolom keluhan
